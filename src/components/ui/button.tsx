  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border/40 bg-transparent hover:bg-accent hover:text-accent-foreground",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        // StayPut custom variants
        calm: "bg-accent-soft text-accent-primary hover:bg-accent-soft/80 border border-primary/20",
        surface: "bg-surface text-foreground hover:bg-surface/80 border border-border/20",
        drift: "bg-transparent text-text-muted hover:text-text-secondary hover:bg-accent-soft/50 border border-dashed border-border/40",
      },
      size: {
